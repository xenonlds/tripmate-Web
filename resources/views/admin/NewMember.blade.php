...
<head>
  ...
  <title>Add New Member - TripMate</title>
...
<body>
  ...
  <div class="container">
    ...
    <div class="form-card">
      <form action="{{ route('admin.member.store') }}" method="POST" id="memberForm">
        @csrf
        ...
        <div class="form-section">
          ...
          <div class="form-grid">
            <div class="form-group">
              ...
              <input type="tel" id="phone_number" name="phone_number" value="{{ old('phone_number') }}" placeholder="01X-XXXXXXX">
              @error('phone_number')
                <span class="error">{{ $message }}</span>
              @enderror
            </div>
            ...
            <div class="form-group full-width">
              ...
              <input type="text" id="nationality" name="nationality" value="{{ old('nationality') }}" placeholder="e.g., Malaysian">
              @error('nationality')
                <span class="error">{{ $message }}</span>
              @enderror
            </div>
